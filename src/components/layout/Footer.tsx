    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-heading font-bold mb-2">ADRAC</h3>
            <p className="text-sm text-primary-foreground/70 mb-4">
              Building great minds for a better future.
            </p>
            <div className="flex flex-col gap-2 text-sm text-primary-foreground/70">
              <span className="flex items-center gap-2"><MapPin className="w-4 h-4 shrink-0" /> Arnold's House, Bluestone Estate, Mowe-Ofada Road, Mowe, Ogun State</span>
          ...
          {/* Sub-Entities */}
          <div>
            <h4 className="font-heading font-semibold mb-4">Sub-Entities</h4>
            <ul className="space-y-2 text-sm text-primary-foreground/70">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              ...
              <li><Link to="/payment-policy" className="hover:text-primary-foreground transition-colors">Payment & Refund Policy</Link></li>
              <li><Link to="/careers" className="hover:text-primary-foreground transition-colors">Careers</Link></li>
              <li><Link to="/media-gallery" className="hover:text-primary-foreground transition-colors">Media & Gallery</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-primary-foreground/50">
            © {new Date().getFullYear()} ADRAC Professional Services Consulting. All rights reserved.
          </p>
          <div className="flex gap-4">
            {/* Social icons placeholder */}
            {["LinkedIn", "Twitter", "Facebook", "Instagram"].map((s) => (
              <a key={s} href="#" className="text-xs text-primary-foreground/50 hover:text-primary-foreground transition-colors">{s}</a>
            ))}
          </div>
        </div>
      </div>
